@extends('layouts.admin', ['activePage' => 'all-doctors', 'titlePage' => __('Edit Doctor')])
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="font-weight-normal">Edit Doctor</h4>
                        ...
                        <form class="form-sample" action="{{ route('doctor.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                        ...
                                        <div id="services-wrapper">
                                            ...
                                            @forelse($services as $index => $svc)
                                                <div class="input-group mb-2 service-item">
                                                    <input type="text" name="services[]" class="form-control service-input service_placeholder" value="{{ $svc }}" placeholder="Enter Service Title" maxlength="50" required>
                                                    @if($loop->first)
                                            ...
                                            @empty
                                                <div class="input-group mb-2 service-item">
                                                    <input type="text" name="services[]" class="form-control service-input service_placeholder" placeholder="Enter Service Title" maxlength="50" required>
                                                    <button type="button" class="btn btn-success btn-add-service">+</button>
                                                </div>
                                            @endforelse
                                        </div>
                                ...
                                @php
                                    ...
                                    $savedTimings = \App\Models\DoctorTimings::where('doctor_id', $user->id)->get()->keyBy('day');
                                @endphp
