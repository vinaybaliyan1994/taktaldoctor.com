@extends('layouts.admin', ['activePage' => 'blog-posts', 'titlePage' => 'Edit Post'])
@section('header-link')
<!-- Summernote CSS (lite version without Bootstrap dependency) -->
...
<style>
    ...
    .blog-input-lg { font-size: 16px !important; padding: 12px 14px !important; font-weight: 500 !important; }
    .blog-label { font-size: 13px !important; font-weight: 600 !important; color: #253237 !important; margin-bottom: 8px !important; margin-top: 0 !important; display: block !important; }
    ...
    .sidebar-card { border: 1px solid #e9ecef; border-radius: 8px; padding: 18px; margin-bottom: 16px; background: #fff; }
    .thumb-drop { width:100%; height:130px; background:#f8fffe; border:2px dashed #28bf96; border-radius:8px; display:flex; align-items:center; justify-content:center; cursor:pointer; transition:.2s; }
    .thumb-drop:hover { background:#e8f8f3; }
    .note-editor.note-frame { border: 1px solid #ced4da !important; border-radius: 6px !important; }
    .note-toolbar { background: #f8f9fa !important; border-bottom: 1px solid #ced4da !important; border-radius: 6px 6px 0 0 !important; }
</style>
@endsection
@section('content')
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="page-header">
            <h3 class="page-title"><i class="mdi mdi-pencil mr-2" style="color:#28bf96;"></i>Edit Post</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <input type="text" name="title" class="blog-input blog-input-lg"
                            value="{{ old('title', $post->title) }}" placeholder="Enter post title here..." required>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <p class="section-title">Excerpt <span style="font-weight:400;text-transform:none;font-size:12px;color:#999;">— short summary shown in listings</span></p>
                        <textarea name="excerpt" class="blog-input" rows="3" placeholder="Write a short summary...">{{ old('excerpt', $post->excerpt) }}</textarea>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div style="margin-bottom:18px;">
                            ...
                            <input type="text" name="seo_title" class="blog-input" value="{{ old('seo_title', $post->seo_title) }}" placeholder="SEO optimized title">
                        </div>
                        <div style="margin-bottom:18px;">
                            <label class="blog-label">Keywords</label>
                            <input type="text" name="keyword" class="blog-input" value="{{ old('keyword', $post->keyword) }}" placeholder="health, doctor, tips">
                        </div>
                        <div>
                            <label class="blog-label">Meta Description</label>
                            <textarea name="description" class="blog-input" rows="3" placeholder="Short description for search engines...">{{ old('description', $post->description) }}</textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="sidebar-card">
                    ...
                    <p style="font-size:12px;color:#999;margin-bottom:10px;">
                        <i class="mdi mdi-calendar-check mr-1" style="color:#28bf96;"></i>
                ...
                <div class="sidebar-card">
                    ...
                    @if($post->thumbnail)
                    <div id="thumb-preview" style="margin-bottom:10px;">
                        <img id="preview-img" src="{{ asset('storage/' . $post->thumbnail) }}"
                            style="width:100%;height:160px;object-fit:cover;border-radius:6px;border:1px solid #e9ecef;">
                        <button type="button" onclick="clearThumb()" style="font-size:11px;color:#fc5a5a;background:none;border:none;padding:4px 0;cursor:pointer;">
                            <i class="mdi mdi-close"></i> Change image
                        </button>
                    </div>
                    <div class="thumb-drop" id="thumb-drop" style="display:none;" onclick="document.getElementById('thumbnail').click()">
                    @else
                    <div id="thumb-preview" style="display:none;margin-bottom:10px;">
                        <img id="preview-img" src="" style="width:100%;height:160px;object-fit:cover;border-radius:6px;border:1px solid #e9ecef;">
                        <button type="button" onclick="clearThumb()" style="font-size:11px;color:#fc5a5a;background:none;border:none;padding:4px 0;cursor:pointer;">
                            <i class="mdi mdi-close"></i> Remove
                        </button>
                    </div>
                    <div class="thumb-drop" id="thumb-drop" onclick="document.getElementById('thumbnail').click()">
                    @endif
                    ...
                    <input type="file" id="thumbnail" name="thumbnail" accept="image/*" style="display:none;" onchange="previewThumb(this)">
