...
Route::post('/demo/callback', [CallbackController::class, 'handle']);
...
Route::get('/voice-ai-receptionist-clinic-hospital', function () {
    return view('frontend.voice-ai-receptionist-clinic-hospital');
})->name('features');

Route::get('/ai-receptionist', function () {
    return view('frontend.ai-receptionist');
})->name('ai.receptionist');

// WhatsApp AI Agent page
Route::get('/whatsApp-ai-agent-hospital-clinic', function () {
    return view('frontend.whatsApp-ai-agent-hospital-clinic');
})->name('whatsApp-ai-agent-hospital-clinic');

// WhatsApp Appointment Booking page
//Route::get('/whatsApp-ai-agent-hospital-clinic', function () {
   // return view('frontend.whatsApp-ai-agent-hospital-clinic');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('blog')->name('blog-')->group(function () {
        ...
        Route::get('/posts/{id}', [BlogPostController::class, 'draft'])->name('post.show');
        ...
        Route::post('/upload-image', [BlogPostController::class, 'uploadImage'])->name('post.upload-image');
        Route::delete('/posts/{id}', [BlogPostController::class, 'destroy'])->name('post.destroys');
